...
const AskQuestion = () => {
    ...
    // const dispatch = useDispatch(askQuestion({questionTitle,questionBody,questionTags,userPosted:User.result.name},navigate)); 
        ...
        <div className='ask-question'>
            <div className="ask-ques-container">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input type='submit' value='Review your question' className='review-btn'  name="" id="" />
                </form>
            </div>
        </div>
  )
